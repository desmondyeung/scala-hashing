...
class StreamingMurmurHash3_32Spec extends FunSpec with StreamingHash32Behaviors {
  ...
  describe("StreamingMurmurHash3_32") {
    it should behave like streamingHash32(StreamingMurmurHash3_32.apply, referenceImpl)
  }
}
