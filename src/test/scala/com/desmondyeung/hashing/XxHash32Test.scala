...
class XxHash32Test extends HashTest {
  ...
  describe("XxHash32") {
    it("should hash a Byte") {
      ...
      val computed = XxHash32.hashByte(bb.array.head, seed32)
    ...
    it("should hash an Int") {
      ...
      val expected = referenceImpl(bb.array, seed32)
      val computed = XxHash32.hashInt(bb.getInt(0), seed32)
    ...
    it("should hash a Long") {
      ...
      val expected = referenceImpl(bb.array, seed32)
      val computed = XxHash32.hashLong(bb.getLong(0), seed32)
    ...
    it("should hash a Array[Byte]") {
      ...
      val expected = referenceImpl(bb.array, seed32)
      val computed = XxHash32.hashByteArray(bb.array, 0, bb.capacity, seed32)
    ...
    it("should hash a heap ByteBuffer") {
      ...
      val expected = referenceImpl(bb.array, seed32)
      val computed = XxHash32.hashByteBuffer(bb, seed32)
    ...
    it("should hash a non-direct ByteBuffer slice") {
      ...
      val expected = referenceImpl(bb.array, seed32)
      val computed = XxHash32.hashByteBuffer(bb, 0, bb.capacity, seed32)
